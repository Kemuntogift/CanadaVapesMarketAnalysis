...
## About the Project
The project focused on understanding buyer behaviour in the Canadian market by product and province, identifying opportunities for growth, and supporting Canada Vapes' goal of increasing its average order value (AOV) beyond $120 per order.
The analysis integrated internal data with research on pricing, vaping taxes, advertising restrictions, and competition to determine consumer buying habits and guide actionable recommendations to increase customer value.
